...
async function triggerEndpoint(env, path) {
  const headers = {
...
__name(triggerEndpoint, "triggerEndpoint");
async function safeTrigger(env, label, path) {
...
__name(safeTrigger, "safeTrigger");
var worker = {
    ...
    ctx.waitUntil(
      (async () => {
        ...
        if (hour === 1) {
          ...
          if ((/* @__PURE__ */ new Date()).getUTCDay() === 1) {
...
// .wrangler/tmp/bundle-RgwzFG/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-RgwzFG/middleware-loader.entry.ts
